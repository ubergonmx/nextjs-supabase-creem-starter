...
export const PRICING_ERRORS: Record<string, string> = {
  ...
  checkout_not_configured:
    'Checkout is not configured. Add CREEM_API_KEY in your deployment environment variables and redeploy.',
  checkout_unauthorized:
    'Checkout is unauthorized. Verify CREEM_API_KEY is valid and matches the configured Creem API environment.',
  checkout_invalid_request:
    'Checkout request is invalid. Verify your Creem product IDs belong to the same environment as your API key.',
  checkout_forbidden:
